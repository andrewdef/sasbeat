...
`${GOPATH}/src/github.com/andrewdef/sasbeat`
...
```
git remote set-url origin https://github.com/andrewdef/sasbeat
...
in the same directory with the name sasbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/andrewdef/sasbeat
git clone https://github.com/andrewdef/sasbeat ${GOPATH}/src/github.com/andrewdef/sasbeat
```
